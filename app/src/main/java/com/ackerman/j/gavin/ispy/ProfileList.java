 ...
 //   Story newsItem;
   ...
   // FloatingActionButton fab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (users == null) {
            ...
            for (int x = 0; x < users.size(); x++) {
                values.add(users.get(x).getName() + " " + users.get(x).getsurname());
                UserImage image = imageService.getImage(users.get(x).getid());
                images.add(image);
            }
        }


        ProfileListAdapter adapter2 = new ProfileListAdapter(this, values, images);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                System.out.println("User id "+ clickUser.getid());
                Intent i = new Intent(ProfileList.this, ViewProfile.class);
                i.putExtra("id", Long.valueOf(clickUser.getid()));
                startActivity(i);
            }
        });
    ...
    private void selectItemFromDrawer(int position) {
        ...
        switch (position){
            case 0:
                startActivity(new Intent(ProfileList.this, NewsfeedActivity.class));
                mDrawerLayout.closeDrawers();
                break;
            case 1:
                startActivity(new Intent(ProfileList.this, StoryActivity.class));
                break;
            case 2:
                startActivity(new Intent(ProfileList.this, ProfileActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 3:
                sess.logoutUser();
