 ...
 */
public class ProfileStoriesActivity extends AppCompatActivity {
  //  private StoryServiceImpl activateService;
   ...
   // Story newsItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(ProfileStoriesActivity.this, ViewStory.class);
    ...
    private void selectItemFromDrawer(int position) {
        ...
        switch (position){
            case 0:
                startActivity(new Intent(ProfileStoriesActivity.this, NewsfeedActivity.class));
                mDrawerLayout.closeDrawers();
                break;
            case 1:
                startActivity(new Intent(ProfileStoriesActivity.this, StoryActivity.class));
                break;
            case 2:
                startActivity(new Intent(ProfileStoriesActivity.this, ProfileActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 3:
                sess.logoutUser();
